                ...
                <div className='py-14 grid md:grid-cols-12 md:gap-10 xl:gap-6 divide-y md:divide-y-0 divide-white/10'>
                    ...
                    <ItemFooter className='pb-5 md:col-span-12 lg:col-span-8 xl:col-span-3'>
                        ...
                        <p className='mt-5'>
                            ...
                            de su familia reciba atención personalizada.
                        </p>
                    ...
                    <ItemFooter className=' py-5 md:col-span-6 lg:col-span-4 xl:col-span-3' title={"Contactenos"}>
                        <ul className='space-y-3 text-base'>
                            ...
                            <li className='flex '>
                                <PhoneIcon className='w-5 h-5 mr-1.5 text-orange-300' />
                                <p>316.960.3848 <br />
                                    +1-669-901-4595
                                </p>
                            </li>
                            <li className='flex '>
                                <EnvelopeIcon className='w-5 h-5 mr-1.5 text-orange-300' />
                                <p>medical@medical.com</p>
                            </li>
                            <li className='flex '>
                                <ClockIcon className='w-5 h-5 mr-1.5 text-orange-300' />
